# Generated by Django 2.0.9 on 2019-05-03 14:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='item',
            name='vendorID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='baskets.Vendor'),
        ),
        migrations.AddField(
            model_name='currentevent',
            name='event_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='baskets.Event'),
        ),
        migrations.AddField(
            model_name='basket',
            name='event',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='baskets.Event'),
        ),
    ]
